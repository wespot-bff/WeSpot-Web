...
internal object Res {
  ...
  public suspend fun readBytes(path: String): ByteArray =
      readResourceBytes("composeResources/wespot_web.composeapp.generated.resources/" + path)
  ...
  public fun getUri(path: String): String =
      getResourceUri("composeResources/wespot_web.composeapp.generated.resources/" + path)
